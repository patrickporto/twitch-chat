...
export class TwitchClientSettings {
    constructor() {
        ...
        (game as Game).settings.register(CANONICAL_NAME, "oauthToken", {
            ...
            hint: (game as Game).i18n.localize(
                "TWITCHCHAT.TwitchOAuthTokenHint"
            ),
            scope: "world",
            requiresReload: true,
            config: true,
        ...
        (game as Game).settings.register(CANONICAL_NAME, "showTwitchEmotes", {
            name: (game as Game).i18n.localize("TWITCHCHAT.ShowTwitchEmotes"),
            hint: (game as Game).i18n.localize(
                "TWITCHCHAT.ShowTwitchEmotesHint"
            ),
            scope: "world",
            requiresReload: true,
            config: true,
    ...
    public get showTwitchEmotes(): boolean {
        return (game as Game).settings.get(
            CANONICAL_NAME,
            "showTwitchEmotes"
        ) as boolean;
